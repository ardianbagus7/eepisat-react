      ...
      >
        ...
        <div className="flex flex-col items-center md:flex-row md:justify-between">
          <a
            ...
            href={`mailto:${email}`}
            className="relative mt-6 text-3xl font-bold text-gray-800 rounded-lg focus:outline-none focus:ring-2 ring-indigo-500 ring-offset-8"
          >
          ...
          <div className="flex items-center mt-8 md:mt-0">
            ...
            <Animated.FromDirection from="bottom" animate={controls} custom={2.4} delay={0.6}>
              <FullRoundButton as="a" href={socials.youtube} className="mx-6" label="Youtube">
                <Icons.Youtube className="w-6" />
              </FullRoundButton>
            </Animated.FromDirection>
