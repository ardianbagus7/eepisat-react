...
import DivisionSectionProps from 'components/organisms/Division/types';
import { useAnimation } from 'framer-motion';
import { useInView } from 'react-intersection-observer';
import Animated from 'components/animations';
import { forwardRef } from 'react';

const Division = forwardRef<HTMLElement | undefined, DivisionSectionProps>(
  ({ title, content, className }: DivisionSectionProps, ref) => {
    ...
    return (
      ...
      >
        ...
        <div className="relative grid grid-cols-1 gap-8 mt-6 sm:grid-cols-2 lg:grid-cols-4">
